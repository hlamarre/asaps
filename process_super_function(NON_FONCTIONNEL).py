...
class SectAmp(Amplitude):
    ...
    def __init__(self, thresh=.03, length=100000):
        super().__init__()
        self.thresh = thresh
        self.length = length
